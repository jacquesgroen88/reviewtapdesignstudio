...
export function useHistory(fabricRef) {
  ...
  const snapshot = useCallback(() => {
    ...
    const json = fabricRef.current.toJSON(['id', 'isQR', 'selectable', 'evented', 'lockMovementX', 'lockMovementY', 'hasControls', 'hasBorders', 'isBackground', 'isGuide', 'smartGuide', 'faceId', 'snapZoneId', 'originalSrc', 'crop', 'bgRemoved'])
