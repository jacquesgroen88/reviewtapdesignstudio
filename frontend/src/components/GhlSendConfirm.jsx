...
// Confirmation-gated "auto-send via the Reviewtap System" control. An automated
...
export default function GhlSendConfirm({ endpoint, title, recipientName, waUrl, whatFires }) {
  ...
  return (
    <div className="space-y-2">
      {msg?.type === 'ok' ? (
        ...
        <button className="btn-secondary w-full justify-center" onClick={() => { setMsg(null); setConfirming(true) }}>
          Auto-send via Reviewtap System
        </button>
      ) : (
